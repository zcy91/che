            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(mcv('shop.verify.saler.view|shop.verify.saler.edit')) { ?><a class='btn btn-default  btn-sm' href="<?php  echo merchUrl('shop/verify/saler/edit', array('id' => $row['id']))?>"><i class='fa fa-edit'></i> <?php if(mcv('shop.verify.saler.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
                             <?php if(mcv('shop.verify.saler.delete')) { ?><a class='btn btn-default btn-sm'  data-toggle='ajaxRemove' href="<?php  echo merchUrl('shop/verify/saler/delete', array('id' => $row['id']))?>" data-confirm="确认删除此店员吗？"><i class='fa fa-trash'></i> 删除</a><?php  } ?>
                           </td>
                    </tr>
                    <?php  } } ?>
