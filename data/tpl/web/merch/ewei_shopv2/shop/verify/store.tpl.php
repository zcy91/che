            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
							  ...
							  <td>
                    <?php if(mcv('shop.verify.store.edit')) { ?>
                    <a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo merchUrl('shop/verify/store/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    <?php  } else { ?>
                    ...
                    <?php  } ?>
                        ...
                        <td>
						  ...
						  <a class='btn btn-default btn-sm' href="<?php  echo merchUrl('shop/verify/store/edit', array('id' => $row['id']))?>"><i class='fa fa-edit'></i> <?php if(mcv('shop.verify.store.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
                          <?php if(mcv('shop.verify.store.delete')) { ?><a class='btn btn-default  btn-sm' data-toggle="ajaxRemove"  href="<?php  echo merchUrl('shop/verify/store/delete', array('id' => $row['id']))?>" data-confirm="确认删除此门店吗？"><i class='fa fa-trash'></i> 删除</a><?php  } ?></td>
