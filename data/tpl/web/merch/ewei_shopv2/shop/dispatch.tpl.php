        ...
        <tbody>
            ...
            <tr>
                <td>
                  ...
                  <td>
                    <?php if(mcv('shop.dispatch.edit')) { ?>
                    	<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo merchUrl('shop/dispatch/displayorder',array('id'=>$item['id']))?>" ><?php  echo $item['displayorder'];?></a>
                    <?php  } else { ?>
                        ...
                        <td style="text-align:left;">
                            <?php if(mcv('shop.dispatch.view|shop.dispatch.edit')) { ?>
                            	<a href="<?php  echo merchUrl('shop/dispatch/edit', array('id' => $item['id']))?>" class="btn btn-default btn-sm" >
                            		<i class='fa fa-edit'></i> <?php if(mcv('shop.dispatch.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                            	</a>
                            <?php  } ?>
                            <?php if(mcv('shop.dispatch.delete')) { ?>
