    ...
    <table class="table table-responsive table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if(mcv('shop.nav.edit')) { ?>
                    	<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo merchUrl('shop/nav/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    <?php  } else { ?>
                    ...
                    <td style="text-align:left;">
                        <?php if(mcv('shop.nav.view|shop.nav.edit')) { ?>
                        	<a href="<?php  echo merchUrl('shop/nav/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm">
                        		<i class='fa fa-edit'></i> <?php if(mcv('shop.nav.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                        	</a>
                        <?php  } ?>
                        <?php if(mcv('shop.nav.delete')) { ?>
