    ...
    <table class="table table-responsive table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if(mcv('shop.banner.edit')) { ?>
                    	<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo merchUrl('shop/banner/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    <?php  } else { ?>
                    ...
                    <td style="text-align:left;">
                        <?php if(mcv('shop.banner.view|shop.banner.edit')) { ?>
                        	<a href="<?php  echo merchUrl('shop/banner/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm">
                        		<i class='fa fa-edit'></i> <?php if(mcv('shop.banner.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                        	</a>
                        <?php  } ?>
                        <?php if(mcv('shop.banner.delete')) { ?>
