                ...
                <div class="col-sm-7"  style="padding-left:10px">
                     ...
                     <p class='form-control-static'>
                        ...
                        <span style="cursor: pointer;" data-toggle="popover" data-trigger="hover" data-html="true"
                              data-content="<img src='<?php  echo $qrcode;?>' alt='链接二维码'>">
        ...
        <div class="col-sm-10">
            <div class="contact-box">
                ...
                <div class="col-sm-7"  style="padding-left:10px">
                     ...
                     <p><?php  echo $user['desc'];?></p>
                     <p class='form-control-static'>
                         付款链接: <a href='javascript:;' class="js-clip" title='点击复制链接' data-url="<?php  echo $url2?>" ><?php  echo $url2?></a>
                        <span style="cursor: pointer;" data-toggle="popover" data-trigger="hover" data-html="true"
                              data-content="<img src='<?php  echo $qrcode2;?>' alt='链接二维码'>">
                            <i class="glyphicon glyphicon-qrcode"></i>
                        </span>
                     </p>
                </div>

                <div class="col-sm-3"  style="padding-left:10px" id="qrcode2">
					<img src="<?php  echo $qrcode2;?>" width="150px" height="150px">
                </div>
				<!--
                <div class="col-sm-1" style="padding-left: 0"><a class="btn btn-primary btn-sm" href="<?php  echo merchUrl('sysset')?>" style="color: #fff"> 点击修改</a></div>
               -->
...
<script type="text/javascript">
	...
	require(['jquery.qrcode2'],function(q){
        $("#qrcode2").qrcode2({
            width: 150, //宽度
            height:150, //高度
            text: "<?php  echo $url2?>"
