<?php defined('IN_IA') or exit('Access Denied');?>  <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
				   ...
				   <span class='help-block'>统一说明在<a href="<?php  echo merchUrl('sale/coupon/set')?>" target='_blank'>【基础设置】</a>中设置，如果使用统一说明，则在优惠券说明前面显示统一说明</span>
						<?php  } else { ?>
	...
	<div class="col-sm-9 col-xs-12">
                  <?php if( mce('sale.coupon' ,$item) ) { ?>
                            <?php  echo tpl_ueditor('desc',$item['desc'],array('dest_dir'=>'merch/'.$_W['merchid']))?>
                            <?php  } else { ?>
