...
<div class='page-heading'><h2>优惠券分类  <?php if(mcv('sale.coupon.category.edit')) { ?><small>拖动可以排序</small><?php  } ?></h2></div>
        ...
        <table class="table  table-responsive">
            ...
            <tbody id='tbody-items'>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(mcv('sale.coupon.category.edit')) { ?>
                    ...
                    <td>
                          <?php if(mcv('sale.coupon.category.delete')) { ?>
                          	<a href="<?php  echo merchUrl('sale/coupon/category/delete', array('id' => $row['id']))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm" data-confirm="确认删除此分类?"><i class="fa fa-trash"></i> 删除</a>
                          <?php  } ?>
                    </td>
