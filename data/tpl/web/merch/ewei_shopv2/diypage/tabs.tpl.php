...
<?php if(mcv('diypage.page.sys|diypage.page.diy')) { ?>
...
<?php if(mcv('diypage.page.mod')) { ?>
	...
	<ul>
		...
		<?php  } ?>
		<?php if(mcv('diypage.page.mod.add')) { ?>
...
<?php if(mcv('diypage.temp')) { ?>
	...
	<ul>
		...
		<?php if(mcv('diypage.temp.category')) { ?>
