...
<form action="" <?php if(mcv('diypage.shop.page.save')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[home]"<?php  } else { ?> disabled<?php  } ?>>
    ...
    <?php  if($_W['plugin']!='merch' && !isset($_W['merch'])) { ?>
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[member]"<?php  } else { ?> disabled<?php  } ?>>
                <option value="">系统默认</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[detail]"<?php  } else { ?> disabled<?php  } ?>>
                <option value="">系统默认</option>
    ...
    <?php  if($_W['plugin']!='merch' && !isset($_W['merch'])) { ?>
        <?php  if(p('commission')) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[commission]"<?php  } else { ?> disabled<?php  } ?>>
                    <option value="">系统默认</option>
        ...
        <?php  if(p('creditshop')) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[creditshop]"<?php  } else { ?> disabled<?php  } ?>>
                    <option value="">系统默认</option>
        ...
        <?php  if(p('seckill')) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[seckill]"<?php  } else { ?> disabled<?php  } ?>>
                    <option value="">系统默认</option>
        ...
        <?php  if(p('exchange')) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <select class="form-control valid" <?php if(mcv('diypage.shop.page.save')) { ?>name="page[exchange]"<?php  } else { ?> disabled<?php  } ?>>
                    <option value="">系统默认</option>
