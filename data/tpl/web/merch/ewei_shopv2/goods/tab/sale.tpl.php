        ...
        <div class="form-group isdiscount_discounts-info">
            <div class="col-sm-12">
                <div class='alert alert-danger'>
                    详细设置促销价格 :
                    <br>
                    如果填写纯数字我们认为单位是积分 例如填写 1 也就是促销价1积分
                    <br>
