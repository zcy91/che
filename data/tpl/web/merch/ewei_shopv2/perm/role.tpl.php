            ...
            <table class="table table-hover  table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <?php if(mcv('perm.role.edit|perm.role.view')) { ?><a class='btn btn-default btn-sm' href="<?php  echo merchUrl('perm/role/edit', array('id' => $row['id']))?>"><i class="fa fa-edit"></i> <?php if(mcv('perm.role.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
                          <?php if(mcv('perm.role.delete')) { ?><a class='btn btn-default  btn-sm' data-toggle="ajaxRemove"  href="<?php  echo merchUrl('perm/role/delete', array('id' => $row['id']))?>" data-confirm="确认删除此角色吗？"><i class="fa fa-remove"></i> 删除</a><?php  } ?>
                        </td>
