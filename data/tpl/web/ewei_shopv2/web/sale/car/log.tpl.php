...
<div class="page-heading"> 
    ...
    <h2>洗车劵记录 <small><?php  if(!empty($car)) { ?>洗车劵: <?php  echo $car['couponname'];?><?php  } ?> 总数: <span class="text-danger"><?php  echo $total;?></span></small></h2>
</div>
...
<table class="table table-hover table-responsive">
    ...
    <tr>
		...
		<td>
		<?php  if($row['used'] ==0) { ?>
		<a class='btn btn-default  btn-sm'  href="<?php  echo webUrl('sale/car/update',array('id' => $row['id']));?>" data-confirm="确定要关闭该洗车券吗？">关闭</a>
		<?php  } else { ?>
		已使用
		<?php  } ?>
		</td>
		...
		<td>
            <span data-toggle='tooltip'  title='施工方是电饭锅松岛枫和双方都'>施工方是电饭锅松岛枫和双方都</span>
        </td>
    </tr>
    <?php  } } ?>
    </tbody>
