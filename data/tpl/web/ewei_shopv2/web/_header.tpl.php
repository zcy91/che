...
<div class="navbar-collapse collapse" id="navbar">
    ...
    <ul class="nav navbar-nav gray-bg">
        ...
        <?php if(mcv('goods')) { ?><li <?php  if($_W['controller']=='goods') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('goods')?>"> 商品</a></li><?php  } ?>
        <?php if(mcv('member')) { ?><li <?php  if($_W['controller']=='member') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('member')?>"> 会员</a></li><?php  } ?>
        <?php if(mcv('order')) { ?><li <?php  if($_W['controller']=='order') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('order')?>"> 订单</a></li><?php  } ?>
        <?php  if(com('sale') || com('coupon')) { ?>
        <?php if(mcv('sale')) { ?><li <?php  if($_W['controller']=='sale') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('sale')?>">营销</a></li><?php  } ?>
        <?php  } ?>
        <?php if(mcv('finance')) { ?><li <?php  if($_W['controller']=='finance') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('finance/log/recharge')?>"> 财务</a></li><?php  } ?>

        <?php if(mcv('statistics.sale')) { ?><li <?php  if($_W['controller']=='statistics') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('statistics')?>">数据</a></li><?php  } ?>
        <?php if(mcv($this->isOpenPlugin())) { ?><li <?php  if($_W['controller']=='plugins' || !empty($_W['plugin'])) { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('plugins')?>">应用</a></li><?php  } ?>

        <?php  if(p('diypage') && !empty($_W['shopset']['diypage']['setmenu'])) { ?><li><a href="<?php  echo webUrl('diypage')?>"> 页面</a></li><?php  } ?>


      	<?php if(mcv('sysset')) { ?><li <?php  if($_W['controller']=='sysset') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('sysset')?>"> 设置</a></li><?php  } ?>
