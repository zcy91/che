                    ...
                    <?php  if(is_array($list)) { foreach($list as $row) { ?>
                        ...
                        <td style="text-align: center;">
                         ...
                         <td style="text-align: center;">
                             ...
                             <?php  } ?>
                             <?php if(cv('creditshop.goods.delete')) { ?>
                             	<a class='btn btn-default btn-sm' data-toggle='ajaxRemove' href="<?php  echo webUrl('creditshop/goods/delete',array('id' => $row['id']));?>" data-confirm="确定要删除该商品吗？" title="删除"><i class='fa fa-remove'></i></a>
                             <?php  } ?>
                         </td>
            </tr>
           <?php  } } ?>
