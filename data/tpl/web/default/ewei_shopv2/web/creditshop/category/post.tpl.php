                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <p class='form-control-static'>
                            <a href='javascript:;' title='点击复制链接' class="js-clip" data-url="<?php  echo mobileUrl('creditshop/list',array('cate'=>$item['id']),true)?>">
                                <?php  echo mobileUrl('creditshop/list',array('cate'=>$item['id']),true)?>
                            </a>
