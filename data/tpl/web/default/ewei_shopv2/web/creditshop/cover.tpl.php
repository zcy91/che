...
<div class='page-heading'><h2>积分商城心入口设置</h2></div>
<form id="setform"  action="" method="post" class="form-horizontal form-validate" >
    <div class="form-group">
        <label class="col-sm-2 control-label">直接链接</label>
        <div class="col-sm-9 col-xs-12">
            <p class='form-control-static'>
                <a href='javascript:;' class="js-clip" title="点击复制链接" data-url="<?php  echo mobileUrl('creditshop',null,true)?>" >
                    <?php  echo mobileUrl('creditshop',null,true)?>
                </a>
