        ...
        <%if page.visit==1%>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline"><input type="checkbox" value="<%level.id%>" class="diy-bind" data-bind-child="visitlevel" data-bind="member" <%if strexists(page.visitlevel.member, level.id)%>checked="checked"<%/if%>> <%level.levelname%></label>
                    <%/each%>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline"><input type="checkbox" value="<%level.id%>" class="diy-bind" data-bind-child="visitlevel" data-bind="commission" <%if strexists(page.visitlevel.commission, level.id)%>checked="checked"<%/if%>> <%level.levelname%></label>
                    <%/each%>
                </div>
            </div>
            <%/if%>
