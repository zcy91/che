...
<table class='table table-responsive' style='table-layout: fixed;'>
    ...
    <tr class='trbody'>
        ...
        <td style='text-align: left;overflow:hidden;border-left:none;'  ><?php  if($g['seckill_task']) { ?>
            ...
            <?php  if($g['seckill_room']) { ?><span class="label label-primary"><?php echo $g['seckill_room']['tag']?:$g['seckill_room']['title']?></span><?php  } ?><br/><?php  } ?><?php  echo $g['title'];?><?php  if(!empty($g['optiontitle'])) { ?><br/><?php  echo $g['optiontitle'];?><?php  } ?><br/><?php  echo $g['goodssn'];?></td>
