<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12" >
        ...
        <label for="cashcredit" class="checkbox-inline">
            <input type="checkbox" name="data[cashcredit]" value="1" id="cashcredit" <?php  if(!empty($data['cashcredit'])) { ?>checked="true"<?php  } ?> /> 提现到商城积分
        </label>
        ...
        <?php  if($data['cashcredit']==1) { ?>提现到商城积分; <?php  } ?>
