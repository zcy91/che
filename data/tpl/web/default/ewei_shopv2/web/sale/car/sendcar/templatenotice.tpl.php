...
<!--新用户扫描成功通知(任务执行者)-->
<h3 class="text-center">洗车卷发送通知</h3>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <textarea id="keyword1" name="data[keyword1]" rows="5" class="form-control"><?php  if(!empty($data['keyword1'])) { ?><?php  echo $data['keyword1'];?><?php  } else { ?>恭喜您获得洗车卷<?php  } ?></textarea>
    </div>
    <div class="col-sm-1 col-xs-2">
