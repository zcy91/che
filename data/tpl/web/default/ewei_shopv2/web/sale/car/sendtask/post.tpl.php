...
<div class="page-heading">
    <span class='pull-right'>
        ...
        <?php  } ?>
        <a class="btn btn-default  btn-sm" href="<?php  echo webUrl('sale/car/sendtask')?>">返回列表</a>
    </span>
    <h2><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>发放任务</h2>
</div>

<form <?php if( ce('sale.car' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
            ...
            <div class="tab-pane active">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <?php if( ce('sale.car' ,$item) ) { ?>
                            <div class="form-group" >
                                <label class="col-sm-2 control-label">选择洗车券</label>
                                <div class="col-sm-9 col-xs-12">
                                    <div class="form-group ">
                                        ...
                                        'multi'=>0,
                                        'value'=>$item['title'],
                                        'url'=>webUrl('sale/car/querycoupons'),
                                        'items'=>$car,
                                        'buttontext'=>'选择优惠券',
                                        'placeholder'=>'请选择优惠券')
                                        )
                        ...
                        <?php  } else { ?>
                            <?php  if(!empty($car)) { ?>
                                <a href="<?php  echo tomedia($car['thumb'])?>" target='_blank'>
                                    <img src="<?php  echo tomedia($car['thumb'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                                </a>
                            <?php  } else { ?>
                            暂无商品
                            <?php  } ?>
