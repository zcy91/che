...
<div class="page-heading"> 
    ...
    <h2>洗车卡使用记录 <small><?php  if(!empty($car)) { ?>洗车卡: <?php  echo $car['couponname'];?><?php  } ?> 总数: <span class="text-danger"><?php  echo $total;?></span></small></h2>
</div>
...
<table class="table table-hover table-responsive">
    ...
    <tr>
		...
		<td>
            <span data-toggle='tooltip'  title='<?php  echo $row['merchname'];?>'>
			<?php  if(empty($row['merchname'])) { ?>未使用<?php  } else { ?><?php  echo $row['merchname'];?><?php  } ?></span>
        </td>
    </tr>
    <?php  } } ?>
    </tbody>
