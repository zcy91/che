    ...
    <div class="col-sm-8">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <textarea name="send_desc" style="height: 150px;resize: none;" class="form-control" placeholder='支持<a href=""></a>标签' name="content" id="content"><?php  echo $list['send_desc'];?></textarea>
