...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">佣金提现</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            ...
            <span class='help-block'>是否允许用户将佣金提出</span>
            <?php  } else { ?>
            <input type="hidden" name="data[withdraw]" value="<?php  echo $data['withdraw'];?>"/>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">佣金提现方式</label>
        <div class="col-sm-9 col-xs-12" >
            <?php if(cv('sysset.trade.edit')) { ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <span class='help-block'>佣金提现时,扣除的手续费.空为不扣除手续费</span>
            <?php  } else { ?>
