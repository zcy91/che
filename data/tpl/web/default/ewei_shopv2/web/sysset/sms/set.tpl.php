...
<form <?php if(cv('sysset.sms.set')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
    ...
    <div class="alert alert-info">
        ...
        <p>短信提醒现支持 <a href="http://www.juhe.cn" target="_blank">聚合数据</a>、<a href="http://www.ztinfo.cn/" target="_blank">助通短信</a>、<a href="http://www.alidayu.com" target="_blank">阿里大于</a>、<a href="http://www.emay.cn" target="_blank">亿美软通</a>三家行业领先接口，接口所有参数需在此处设置。</p>
    ...
    <div class="form-group-title">助通短信<small style="padding-left: 10px;"><a target="_blank" href="http://www.ztinfo.cn">立即申请</a></small>
            <span class="pull-right">
                <input type="hidden" value="<?php  echo $item['ztinfo'];?>" name='ztinfo' />
                <input class="js-switch small" type="checkbox" <?php  if(!empty($item['ztinfo'])) { ?>checked<?php  } ?>/>
            </span>
    </div>
    <div class=" sms-ztinfo" style="<?php  if(empty($item['ztinfo'])) { ?>display: none;<?php  } ?>">
        <div class="form-group">
            <label class="col-sm-2 control-label must">Username</label>
            <div class="col-sm-9 col-xs-12">
                <input type="text" name="ztinfo_name" class="form-control valid" value="<?php  echo $item['ztinfo_name'];?>" data-rule-required="true">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label must">Password</label>
            <div class="col-sm-9 col-xs-12">
                <input type="text" name="ztinfo_pawd" class="form-control valid" value="<?php  echo $item['ztinfo_pawd'];?>" data-rule-required="true">
            </div>
        </div>
    </div>
