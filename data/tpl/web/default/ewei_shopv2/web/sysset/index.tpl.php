...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <label class="radio-inline">
                <input type="radio" name="data[getinfo]" value="1" <?php  if(empty($data['getinfo']) || $data['getinfo']==1) { ?>checked=""<?php  } ?>> 开启                        </label>
            <?php  } else { ?>
            <input type="hidden" name="data[name]" value="<?php  echo $data['name'];?>"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.shop.edit')) { ?>
            <label class="radio-inline">
                <input type="radio" name="data[funbar]" value="0" <?php  if(empty($data['funbar'])) { ?>checked=""<?php  } ?>> 关闭
            </label>
            <label class="radio-inline">
                <input type="radio" name="data[funbar]" value="1" <?php  if(intval($data['funbar'])==1) { ?>checked=""<?php  } ?>> 样式一(左侧满屏可折叠)
            </label>
            <label class="radio-inline">
                <input type="radio" name="data[funbar]" value="2" <?php  if(intval($data['funbar'])==2) { ?>checked=""<?php  } ?>> 样式二(右侧跟随)
            </label>
            <?php  } else { ?>
            <input type="hidden" name="data[name]" value="<?php  echo $data['name'];?>"/>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">全球分红奖</label>
        <div class="col-sm-9 col-xs-12">
            <div class="input-group">
                <div class='input-group-addon'>需向门店支付服务费：改为</div>
                <input name="data[fuwuchar]" class="form-control" value="<?php  echo $data['fuwuchar'];?>">
            </div>
            <div class="input-group">
                <div class='input-group-addon'>尾款购车：改为</div>
                <input name="data[wkchar]" class="form-control" value="<?php  echo $data['wkchar'];?>">
            </div>
            <div class="input-group">
                <div class='input-group-addon'>尾款也可分期改为：改为</div>
                <input name="data[fqchar]" class="form-control" value="<?php  echo $data['fqchar'];?>">
            </div>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">升级商家返回</label>
        <div class="col-sm-9 col-xs-12">
            <div class="input-group">
                <div class='input-group-addon'>升级商家返回金额</div>
                <input name="data[fanhui]" class="form-control" value="<?php  echo $data['fanhui'];?>">
                <div class='input-group-addon'>元</div>
            </div>
        </div>
    </div>
    <div class="form-group" >
        <label class="col-sm-2 control-label">二级分销业务提成（分佣）设置</label>
        <div class="col-sm-9 col-xs-12">
            <div class="input-group">
                <div class='input-group-addon'>一级业务提成</div>
                <input name="data[level_1]" class="form-control" value="<?php  echo $data['level_1'];?>">
                <div class='input-group-addon'>元</div>
            </div>
            <div class="input-group">
                <div class='input-group-addon'>二级业务提成</div>
                <input name="data[level_2]" class="form-control" value="<?php  echo $data['level_2'];?>">
                <div class='input-group-addon'>元</div>
            </div>
            <div class="input-group">
                <div class='input-group-addon'>“商家”直推的会员升级商家可以得到推广费用</div>
                <input name="data[merch_merch]" class="form-control" value="<?php  echo $data['merch_merch'];?>">
                <div class='input-group-addon'>元/位</div>
            </div>
            <div class="input-group">
                <div class='input-group-addon'>“商家”可享受直推会员业务提成的</div>
                <input name="data[merch_level_1]" class="form-control" value="<?php  echo $data['merch_level_1'];?>">
                <div class='input-group-addon'>%佣金分红</div>
            </div>
            <div class="input-group">
                <div class='input-group-addon'>“商家”可享受伞下二级内会员的</div>
                <input name="data[merch_level_2]" class="form-control" value="<?php  echo $data['merch_level_2'];?>">
                <div class='input-group-addon'>%的业绩分红</div>
            </div>
        </div>
    </div>
    <div class="form-group">
