...
<div class="alert alert-info">
    <b>注意：</b>
    <p>请将公众平台模板消息所在行业选择为： IT科技/互联网|电子商务， 其他/其他</p>
    <p>模板消息开启后，将自动申请系统默认模板至您的微信公众平台。<a href="<?php  echo webUrl('sysset/tmessage')?>" title="模板消息库">点击进入自定义消息库</a><?php  if($opensms) { ?>，<a href="<?php  echo webUrl('sysset/sms')?>" title="短信消息库">点击进入短信消息库</a><?php  } ?></p>
</div>
