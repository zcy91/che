...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('member.list.edit')) { ?>
        <input type="text" name="data[idnumber]" class="form-control" value="<?php  echo $member['idnumber'];?>" />
        <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('member.list.edit')) { ?>
        <input type="text" name="data[riqi]" class="form-control" value="<?php  echo $member['riqi'];?>" placeholder="例:2018-08-08" />
        <?php  } else { ?>
        <div class='form-control-static'><?php  echo $member['riqi'];?></div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('member.list.edit')) { ?>
        <input type="text" name="data[weixin]" class="form-control" value="<?php  echo $member['card'];?>" />
        <?php  } else { ?>
        <div class='form-control-static'><?php  echo $member['card'];?></div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label">行驶证登记日期</label>
    <div class="col-sm-9 col-xs-12">
