...
<?php if(cv('member.list|member.level|member.group|member.list.birthday')) { ?>
...
<ul>
    ...
    <?php  } ?>	<?php if(cv('member.birthday')) { ?>    	<li <?php  if($_W['action']=='member.birthday') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('member/birthday')?>">会员生日</a></li>    <?php  } ?>
</ul>
<?php  } ?>
