	...
	<div class="option-picker">
		<div class="option-picker-inner">
			<div class="option-picker-cell goodinfo">
				...
				<div class="info info-price text-danger" style="background: none;"><span>&yen;<span class='price'><span class="option_money"></span>+<span class="option_credit"></span><?php  echo $_W['shopset']['trade']['credittext'];?></span></span></div>
				<div class="info info-total">
					库存 <span class='total text-danger option_total' style="background: none;">10</span>
				</div>
