		...
		<div id="container">
			...
			<div class="fui-list-group" id="container<%key%>">
				...
				>
					...
					<div class='fui-list-angle'>
						<span class="price">积分:<span class='marketprice'><%g.marketprice%></span></span>
	...
	<script id="tpl_member_cart_footer" type="text/html">
		...
		<div class="fui-footer cartmode" style="bottom: 2.4rem">
			<div class="fui-list noclick">
				...
				<div class="fui-list-inner">
					<div class='subtitle'>合计：<span class="text-danger">积分:</span><span class='text-danger totalprice'><%totalprice%></span></div>
