...
<div class='fui-page order-create-page'>
    ...
    <div class='fui-content  navbar'>
        ...
        <div id="carrierTab" class="fui-tab fui-tab-danger">
            <?php  if($createInfo['goodspcate']!=1174) { ?>
            <a data-tab="tab1" class="active">快递配送</a>
            <a data-tab="tab2" style="display: none">上门自提</a>
            <?php  } else { ?>
            <a data-tab="tab1" style="display: none">快递配送</a>
            <a data-tab="tab2" class="active">预约上门</a>
            <?php  } ?>
        </div>
        ...
        <!--地址选择-->
        <div class="fui-list-group" id='addressInfo' data-addressid="<?php  echo intval($address['id'])?>" <?php  if($createInfo['goodspcate']==1174) { ?>style="display:none"<?php  } ?>>
...
<!--自提点选择-->
<div class="fui-list-group"  id="carrierInfo" <?php  if($createInfo['goodspcate']!=1174) { ?>style="display:none"<?php  } ?>>
...
<div class="fui-cell-group sm" id="memberInfo" <?php  if(!$isverify && !$isvirtual && $createInfo['goodspcate']!=1174) { ?>style="display:none"<?php  } ?>>
...
<div class="fui-list-group" >
    ...
    <div class="fui-list goods-item">
        ...
        <?php  if($createInfo['goodspcate']!=1174) { ?>
        <div class='fui-list-angle'>
            <span class="price "><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?> <span class='marketprice'><?php  if($g['packageprice'] > $g['unitprice']) { ?><?php  echo $g['packageprice'];?><?php  } else if($g['marketprice'] > $g['unitprice']) { ?><?php  echo $g['marketprice'];?><?php  } else { ?><?php  echo $g['unitprice'];?><?php  } ?></span></span>
            <span class="total">
    ...
    <div class='fui-cell-group' >
        ...
        <div class="fui-cell" style="padding:0 0 0 0.5rem;"<?php  if($createInfo['goodspcate']!=1174) { ?>style="display:none;"<?php  } ?>>
...
<?php  if($createInfo['goodspcate']!=1174) { ?>
        <div class="fui-cell" >
            <div class="fui-cell-info" style="text-align: right;">共 <span id='goodscount' class='text-danger'><?php  echo $total;?></span> 件商品 合计：<span class="text-danger"><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?> <span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  echo number_format($goodsprice,2)?></soan></span></div>
        </div><?php  } ?>
...
<div class="fui-cell-group sm">
    ...
    <div class="fui-cell">
        ...
        <div class="fui-cell-info"></div>
        <div class="fui-cell-remark noremark"><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?> <span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  if(!empty($exchangeOrder)) { ?><?php  echo $exchangeprice;?><?php  } else { ?><?php  echo number_format($goodsprice,2)?><?php  } ?></span></div>
    </div>
    <?php  } else { ?>
    <div class="fui-cell">
        <div class="fui-cell-label" >首付</div>
        <div class="fui-cell-info"></div>
        <div class="fui-cell-remark noremark">&yen;<span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  echo $shoufu;?>万</span></div>
    </div>
    ...
    <div class="fui-cell discount"  style="display: none">
        ...
        <div class="fui-cell-info"></div>
        <div class="fui-cell-remark noremark"><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?> <span id='showdiscountprice' class='showdiscountprice'></span></div>
...
<div class="fui-cell">
    ...
    <div class="fui-cell-info"></div>
    <div class="fui-cell-remark noremark"><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?><span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>dispatchprice<?php  } ?>'><?php  if(!empty($exchangeOrder)) { ?><?php  echo $exchangepostage;?><?php  } else { ?><?php  echo number_format($dispatch_price,2)?><?php  } ?></span></div>
</div>
<?php  } else { ?>
<div class="fui-cell">
    <div class="fui-cell-label" >月供</div>
    <div class="fui-cell-info"></div>
    <div class="fui-cell-remark noremark"> <span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  echo $yuegong;?>元</span></div>
</div>
<div class="fui-cell">
    <div class="fui-cell-label" >期数</div>
    <div class="fui-cell-info"></div>
    <div class="fui-cell-remark noremark"> <span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  echo $qishu;?>期</span></div>
</div>
...
<div class="fui-navbar order-create-checkout">
    <a href="javascript:;" class="nav-item total" <?php  if($createInfo['goodspcate']==1174) { ?>style="display:none;"<?php  } ?>>
        <p><?php  if($packageid) { ?><span class="text-danger" style="font-size: 0.6rem;">(套餐优惠&yen;<?php  echo number_format($marketprice-$goodsprice,2)?>)</span><?php  } ?>
            需付：<span class="text-danger "><?php  if($merch_data['merchname']) { ?>积分：<?php  } else { ?>&yen;<?php  } ?> <span class="<?php  if(!$packageid && empty($exchangeOrder)) { ?>totalprice<?php  } ?>">
                <?php  if(!empty($exchangeOrder)) { ?><?php  echo $exchangerealprice;?><?php  } else { ?><?php  echo number_format($realprice,2)?><?php  } ?></span></span>
        </p>
    </a>
    <a href="javascript:;" class="nav-item btn btn-danger buybtn"><?php  if($createInfo['goodspcate']!=1174) { ?>立即支付<?php  } else { ?>确定预约<?php  } ?></a>
</div>
