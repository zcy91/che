...
<div class='fui-page order-detail-page'>
    ...
    <div class='fui-footer'>
        ...
        <a data-nocache="true" class="btn btn-default" href="<?php  echo mobileUrl('order/refund',array('id'=>$order['id']))?>"><?php  if($order['status'] ==1) { ?>申请退款<?php  } else { ?>申请售后<?php  } ?><?php  if(!empty($order['refundstate'])) { ?>中<?php  } ?></a>
        <?php  } ?>
