...
<div class='fui-page  fui-page-current'>
	...
	<div class='fui-content' style='margin-top:5px;'>
		...
		<div class="tishi" style="width:100%;color:red;text-align:center;margin-top:1%;">注意：以下信息填写必须属实！</div> 
		...
		<div class="fui-cell-group">
			...
			<div class="fui-cell" style="display: none">
				...
				<div class="fui-cell-info"><input type="text"  class='fui-input'  id='city' name='city' placeholder="请选择城市"  value="<?php  if(!empty($member) && !empty($member['city'])) { ?><?php  echo $member['province'];?> <?php  echo $member['city'];?><?php  } ?>" readonly/></div>
			</div>
			<div class="fui-cell">
				<div class="fui-cell-label">车牌号</div>
				<div class="fui-cell-info"><input type="text"  class='fui-input'  id='card' name='card' placeholder="请输入您的车牌号"  value="<?php  echo $member['card'];?>" maxlength="7" /></div>
			</div>
			<div class="fui-cell">
				<div class="fui-cell-label">行驶证登记日期</div>
				<div class="fui-cell-info"><input type="text"  class='fui-input'  id='birthday' name='birthday' placeholder="行驶证登记日期"  value="<?php  echo $member['birthday'];?>" readonly/></div>
			</div>
