        ...
        <form method='post' class='form-ajax' >
            ...
            <div class='fui-cell-group'>
                ...
                <div class='fui-cell'>
                    ...
                    <div class='fui-cell-info'><input type="text" id='areas'  name='areas' value="<?php  if(!empty($address)) { ?><?php  echo $address['province'];?> <?php  echo $address['city'];?> <?php  echo $address['area'];?><?php  } ?>" placeholder="所在地区"  class="fui-input" readonly=""/></div>
                </div>
