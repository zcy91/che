<?php defined('IN_IA') or exit('Access Denied');?><script type="text/html" id="option-picker">
	...
	<div class="option-picker-cell goodinfo">
	    ...
	    <div class="info info-price text-danger"><span>￥<span class='price'><%if goods.maxprice == goods.minprice%><%goods.minprice%><%else%><%goods.minprice%>~<%goods.maxprice%><%/if%></span></span></div>
