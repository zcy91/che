<?php
/**
 * [WeEngine System] Copyright (c) 2014 www.tule5.com
...
function cloud_sms_info() {
	...
	$dat = cloud_request('http://www.tule5.com', $pars);
...
function cloud_download($path, $type = '') {
	...
	$dat = cloud_request('http://www.tule5.com', $pars, $headers, 300);
	//if(is_error($dat)) {
...
function cloud_cron_create($cron) {
	...
	$result = cloud_request('http://www.tule5.com', $pars);
