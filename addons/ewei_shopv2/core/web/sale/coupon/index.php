	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			else 
			{
				...
				file_put_contents(__dir__."/tianjyhj02.txt",json_encode($data));
				$data2 = pdo_insert('ewei_shop_coupon', $data);
				file_put_contents(__dir__."/tianjyhj.txt",json_encode($data2));
				$id = pdo_insertid();
