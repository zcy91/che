...
class Index_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		$carlist = pdo_fetchall('SELECT * FROM ' . tablename('ewei_shop_goods')  . 'WHERE pcate = 1174 and status =1   ORDER BY id DESC limit 4');
		file_put_contents(__DIR__.'/a.php',json_encode($carlist));
