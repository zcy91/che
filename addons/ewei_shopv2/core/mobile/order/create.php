...
class Create_EweiShopV2Page extends MobileLoginPage 
{
	...
	public function main() 
	{
		...
		if (!($packageid)) 
		{
			...
			extract($diyformdata);
			$id = intval($_GPC['id']);
            $goodspcate = intval($_GPC['goodspcate']);
	...
	public function submit()
	{
		...
		$order = array();
		file_put_contents(__DIR__.'/a1.php',$pcate);
		if($pcate==1174){
            $order['goodspcate'] = $pcate;
            $order['zhidaojia'] = $zhidaojia;
        }
