define(['core', 'tpl', 'biz/car/picker', 'biz/member/favorite', 'biz/member/cart', 'biz/plugin/diyform'], function(core, tpl, picker, favorite, cart, diyform) {
    var modal = {};
    modal.init = function(params) {
        modal.seckillinfo = params.seckillinfo;
        modal.goodsid = params.goodsid;
        modal.goodspcate = params.goodspcate;
        modal.optionid = 0;
        modal.total = 1;
        ...
        if(modal.goodspcate!=1174){
            ...
            if(modal.goodspcate==1174){
                $(".bottom-buttons .buybtn").click(function() {
                        $.router.load(core.getUrl('ordercar/create', {
                        id: modal.goodsid,
                        optionid: modal.optionid,
                        total: 1,
                            goodspcate: modal.goodspcate
                    }), false)
                })
                    ...
                    if ($("#giftid") && giftid == '') {
                        ...
                        if ($('.diyform-container').length > 0) {
                            ...
                            if (!diyformdata) {
                                ...
                                core.json('ordercar/create/diyform', {
                                    id: modal.goodsid,
