								...
								if (!(empty($goods)) && is_array($goods)) 
								{
									foreach ($goods as $index => $good ) 
									{
										...
										if (!(empty($showgoods))) 
										{
											$childid = rand(1000000000, 9999999999);
											$childid = 'C' . $childid;
											$item['data'][$childid] = array('thumb' => $good['thumb'],'pcate'=> $good['pcate'], 'zhidaojia' => $good['zhidaojia'],'title' => $good['title'],'qishu' => $good['qishu'],'shoufu' => $good['shoufu'],'yuegong' => $good['yuegong'],'shorttitle' => $good['shorttitle'], 'price' => $good['minprice'], 'gid' => $good['id'], 'total' => $good['total'], 'bargain' => $good['bargain'], 'productprice' => $good['productprice'], 'credit' => $good['credit'], 'ctype' => $good['type'], 'gtype' => $good['goodstype'], 'sales' => $good['sales']);
										}
									}
								}
							}
