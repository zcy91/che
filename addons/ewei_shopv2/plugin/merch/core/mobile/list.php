...
class List_EweiShopV2Page extends PluginMobilePage
{
	...
	public function ajaxmerchuser()
	{
		...
		if (!empty($_GPC['keyword'])) {
            ...
            $data['like'] = array('salecate' => $_GPC['keyword']);
		}
		...
		$data = array_merge($data, array('status' => 1, 'field' => 'id,uniacid,merchname,salecate,desc,logo,groupid,cateid,address,tel,lng,lat'));
