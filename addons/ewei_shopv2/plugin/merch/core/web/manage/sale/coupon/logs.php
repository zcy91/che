...
class Logs_EweiShopV2Page extends MerchWebPage
{
	...
	public function main()
	{
		...
		if (!(empty($keyword))) 
		{
			...
			$condition = 'd.backtype =0  and d.used =1  and d.merchid='.$_W['merchid'];  /*可搜索所有记录，列表只读当前在商户使用的820*/
		}
	...
	public function update(){
		...
		header("Location:https://jyqc.hejiewl.com/web/merchant.php?c=site&a=entry&m=ewei_shopv2&do=web&r=sale.coupon.logs");
	}
}
