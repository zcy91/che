...
class Index_EweiShopV2Page extends MerchWebPage 
{
	public function main() 
	{
		...
		include_once "../framework/library/qrcode/phpqrcode.php";
		$url2="https://jyqc.hejiewl.com/app/index.php?i=1&c=entry&m=ewei_shopv2&do=mobile&r=shanfu&merchid=".$merchid; //814
			   
		$filename = "../attachment/images/1/qrcode/".$_W['merchid'].'1.png';
		$errorCorrectionLevel = 'L';
        $matrixPointSize = 5; 
		QRcode::png($url2, $filename , $errorCorrectionLevel, $matrixPointSize, 2);
		$qrcode2="/attachment/images/1/qrcode/".$_W['merchid'].'1.png';
